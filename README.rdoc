= Ryan Bates Dot Files - Modified

I have taken the original dot files Ryan Bates created(thank you very much!) and configured them for the way I set up a system.  I've modified only a few basic entries currently.


== Installation

  git clone git://github.com/aethiolas/dotfiles ~/.dotfiles
  cd ~/.dotfiles
  rake install
